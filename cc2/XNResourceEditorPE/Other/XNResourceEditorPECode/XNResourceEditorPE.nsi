...
!define NAME "XNResourceEditorPE"
!define FRIENDLYNAME "XNResourceEditor Portable Edition"
!define APP "XNResourceEditor"
!define VER "3.0.0.1"
!define WEBSITE "http://software.otbsupport.com/portableapps/xnresourceeditorpe"
!define DEFAULTEXE "XNResourceEditor.exe"
!define DEFAULTAPPDIR "XNResourceEditor"
...
Name "${NAME}"
OutFile "${NAME}.exe"
Caption "${FRIENDLYNAME} - PE Resource Explorer"
...
Section "Main"
        ;=== Find the INI file, if there is one
        		...
        		Sleep 700
	               	...
	               	${Registry::SaveKey} "HKEY_CURRENT_USER\Software\Woozle" "$SETTINGSDIRECTORY\settings.reg" "/G=1" $R0
